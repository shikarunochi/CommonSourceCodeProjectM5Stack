...
private:
	...
	scrntype_t palette_pc_half[8+8][8+8];		// 0-7:text, 8-15:cg for Half display
...
public:
	DISPLAY_(VM_TEMPLATE* parent_vm, EMU* parent_emu) : DEVICE(parent_vm, parent_emu)
	{
