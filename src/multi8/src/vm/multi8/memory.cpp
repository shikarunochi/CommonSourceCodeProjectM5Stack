...
void MEMORY::initialize()
{
	...
	fdc = (uint8_t*)ps_malloc(0x1000);
	ram0 = (uint8_t*)ps_malloc(0x8000);
	ram1 = (uint8_t*)ps_malloc(0x8000);
	vram = (uint8_t*)ps_malloc(0x10000);
	wdmy = (uint8_t*)ps_malloc(0x1000);
	rdmy = (uint8_t*)ps_malloc(0x1000);

	// init memory
	memset(rom, 0xff, 0x8000);
	memset(fdc, 0xff, 0x1000);
	memset(ram0, 0, 0x8000);
	memset(ram1, 0, 0x8000);
...
bool MEMORY::process_state(FILEIO* state_fio, bool loading)
{
	...
	state_fio->StateArray(ram0, 0x8000, 1);
	state_fio->StateArray(ram1, 0x8000, 1);
	state_fio->StateArray(vram, 0x10000, 1);
