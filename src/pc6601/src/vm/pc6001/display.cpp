...
void DISPLAYPC6001::reset()
{
	vram_ptr = ram_ptr + 0xe000;
}

void DISPLAYPC6001::write_io8(uint32_t addr, uint32_t data)
{
...
void DISPLAYPC6001::draw_screen()
{
...
bool DISPLAYPC6001::process_state(FILEIO* state_fio, bool loading)
{
