...
{
	kanji = (uint8_t*)ps_malloc(0x20000);
	dic = (uint8_t*)ps_malloc(0x4000);

	// load rom images
	memset(kanji, 0xff, 0x20000);
	memset(dic, 0xff, 0x4000);
