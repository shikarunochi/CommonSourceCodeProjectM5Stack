...
DISPLAY_::DISPLAY_(VM_TEMPLATE* parent_vm, EMU* parent_emu) : DEVICE(parent_vm, parent_emu)
{
	ins_led = NULL;
	kana_led = NULL;
	caps_led = NULL;
...
void DISPLAY_::reset_some_devices()
{
	int i;
	double usec;
...
void DISPLAY_::reset_subcpu(bool _check_firq)
{
...
void DISPLAY_::setup_display_mode(void)
{
#if defined(_FM77AV40) || defined(_FM77AV40EX) || defined(_FM77AV40SX)
...
void DISPLAY_::set_multimode(uint8_t val)
{
#if !defined(_FM8)	
...
uint8_t DISPLAY_::get_multimode(void)
{
#if defined(_FM8)
	return 0xff;
#else
...
uint8_t DISPLAY_::get_cpuaccessmask(void)
{
	return multimode_accessmask & 0x07;
}

void DISPLAY_::set_dpalette(uint32_t addr, uint8_t val)
{
	scrntype_t r, g, b;
	addr &= 7;
...
uint8_t DISPLAY_::get_dpalette(uint32_t addr)
{
#if defined(_FM8)
	return 0xff;
#else
...
void DISPLAY_::leave_display(void)
{
}

void DISPLAY_::halt_subsystem(void)
{
	//halt_flag = false;
  	halt_subcpu();
}

void DISPLAY_::restart_subsystem(void)
{
	//halt_flag = false;
#if defined(_FM77AV_VARIANTS)
	if(subcpu_resetreq) {
...
//SUB:D408:R
void DISPLAY_::set_crtflag(void)
{
	crt_flag = true;
	vram_wrote = true;
}
...
//SUB:D408:W
void DISPLAY_::reset_crtflag(void)
{
	crt_flag = false;
	vram_wrote = true;
}
...
//SUB:D402:R
uint8_t DISPLAY_::acknowledge_irq(void)
{
	cancel_request = false;
	do_irq(false);
	return 0xff;
...
// SUB:D404 : R 
uint8_t DISPLAY_::attention_irq(void)
{
...
// SUB:D405:W
void DISPLAY_::set_cyclesteal(uint8_t val)
{
#if !defined(_FM8)
# if defined(_FM77_VARIANTS) || defined(_FM77AV_VARIANTS)	
	vram_wrote = true;
...
void DISPLAY_::setup_400linemode(uint8_t val)
{
#if defined(_FM77L4)
	// 400Line board.
...
//SUB:D409:R
uint8_t DISPLAY_::set_vramaccess(void)
{
	vram_accessflag = true;
	//enter_display();
	return 0xff;
...
//SUB:D409:W
void DISPLAY_::reset_vramaccess(void)
{
...
//SUB:D40A:R
uint8_t DISPLAY_::reset_subbusy(void)
{
	sub_busy = false;
	return 0xff;
}
...
//SUB:D40A:W
void DISPLAY_::set_subbusy(void)
{
	sub_busy = true;
}
...
#if defined(_FM77AV_VARIANTS)
// D410
void DISPLAY_::alu_write_cmdreg(uint32_t val)
{
...
// D411
void DISPLAY_::alu_write_logical_color(uint8_t val)
{
...
// D412
void DISPLAY_::alu_write_mask_reg(uint8_t val)
{
	uint32_t data = (uint32_t)val;
...
// D413 - D41A
void DISPLAY_::alu_write_cmpdata_reg(int addr, uint8_t val)
{
	uint32_t data = (uint32_t)val;
	addr = addr & 7;
...
// D41B
void DISPLAY_::alu_write_disable_reg(uint8_t val)
{
	uint32_t data = (uint32_t)val;
...
// D41C - D41F
void DISPLAY_::alu_write_tilepaint_data(uint32_t addr, uint8_t val)
{
	uint32_t data = (uint32_t)val;
	switch(addr & 3) {
		case 0: // $D41C
...
// D420
void DISPLAY_::alu_write_offsetreg_hi(uint8_t val)
{
	call_write_data8(alu, ALU_OFFSET_REG_HIGH, val & 0x7f);
}
 
// D421
void DISPLAY_::alu_write_offsetreg_lo(uint8_t val)
{
	call_write_data8(alu, ALU_OFFSET_REG_LO, val);
}

// D422
void DISPLAY_::alu_write_linepattern_hi(uint8_t val)
{
	call_write_data8(alu, ALU_LINEPATTERN_REG_HIGH, val);
}

// D423
void DISPLAY_::alu_write_linepattern_lo(uint8_t val)
{
	call_write_data8(alu, ALU_LINEPATTERN_REG_LO, val);
}

// D424-D42B
void DISPLAY_::alu_write_line_position(int addr, uint8_t val)
{
	uint32_t data = (uint32_t)val;
	switch(addr) {
		case 0:  
...
//SUB:D430:R
uint8_t DISPLAY_::get_miscreg(void)
{
	uint8_t ret;
...
//SUB:D430:W
void DISPLAY_::set_miscreg(uint8_t val)
{
...
// Main: FD13
void DISPLAY_::set_monitor_bank(uint8_t var)
{
# if defined(_FM77AV40) || defined(_FM77AV40EX) || defined(_FM77AV40SX)
	if((var & 0x04) != 0){
		monitor_ram = true;
...
// FD30
void DISPLAY_::set_apalette_index_hi(uint8_t val)
{
	apalette_index.b.h = val & 0x0f;
}

// FD31
void DISPLAY_::set_apalette_index_lo(uint8_t val)
{
	apalette_index.b.l = val;
}

void DISPLAY_::calc_apalette(uint16_t idx)
{
	uint8_t r, g, b;
	idx = idx & 4095;
...
// FD32
void DISPLAY_::set_apalette_b(uint8_t val)
{
	uint16_t index;
	uint8_t tmp;
...
// FD33
void DISPLAY_::set_apalette_r(uint8_t val)
{
	uint16_t index;
	uint8_t tmp;
	index = apalette_index.w.l;
...
// FD34
void DISPLAY_::set_apalette_g(uint8_t val)
{
	uint16_t index;
	uint8_t tmp;
	index = apalette_index.w.l;
...
void DISPLAY_::copy_vram_blank_area(void)
{
}

void DISPLAY_::copy_vram_per_line(int begin, int end)
{
	uint32_t src_offset;
	uint32_t yoff_d1 = 0;
	uint32_t yoff_d2 = 0;
...
//#if defined(_FM77AV_VARIANTS) || defined(_FM77L4)
void DISPLAY_::event_callback_hdisp(void)
{
	bool f = false;
	double usec;
	hblank = false;
...
void DISPLAY_::event_callback_hblank(void)
{
	bool f = false;
	bool ff = false;
	double usec;
...
void DISPLAY_::event_callback_vstart(void)
{
	double usec; 
	vblank = true;
	vsync = false;
...
void DISPLAY_::event_callback_vsync(void)
{
	double usec; 
	vblank = true;
	hblank = false;
...
//#endif
#if defined(_FM77L4)
void DISPLAY_::cursor_blink_77l4()
{
...
void DISPLAY_::event_callback(int event_id, int err)
{
	double usec;
	bool f;
	switch(event_id) {
...
void DISPLAY_::event_vline(int v, int clock)
{
#if !defined(_FM77AV_VARIANTS) && !defined(_FM77L4)
	bool ff = false;
...
uint32_t DISPLAY_::read_signal(int id)
{
	uint32_t retval = 0;
	switch(id) {
...
void DISPLAY_::write_signal(int id, uint32_t data, uint32_t mask)
{
	//Serial.printf("Display:Write signal:%d,%X,%X\n",id,data,mask);
...
uint32_t DISPLAY_::read_mmio(uint32_t addr)
{
...
uint32_t DISPLAY_::read_vram_data8(uint32_t addr)
{
	uint32_t offset;
	uint32_t vramaddr;
...
void DISPLAY_::write_dma_data8(uint32_t addr, uint32_t data)
{
...
void DISPLAY_::write_vram_data8(uint32_t addr, uint8_t data)
{
	uint32_t offset;
	uint32_t color = (addr >> 14) & 0x03;
	uint32_t vramaddr;
...
uint32_t DISPLAY_::read_cpu_vram_data8(uint32_t addr)
{
	uint8_t color;
#if defined(_FM77AV_VARIANTS)
	if(use_alu) {
...
uint32_t DISPLAY_::read_dma_vram_data8(uint32_t addr)
{
	return read_vram_data8(addr);
}

void DISPLAY_::init_read_table(void)
{
	uint32_t _at;
	for(_at = 0 ; _at < 0xc000; _at += 0x80) {
		read_cpu_func_table[_at >> 7] = &DISPLAY_::read_cpu_vram_data8;
		read_dma_func_table[_at >> 7] = &DISPLAY_::read_dma_vram_data8;
	}
	for(_at = 0xc000; _at < 0xd000; _at += 0x80) {
		read_cpu_func_table[_at >> 7] = &DISPLAY_::read_console_ram;
		read_dma_func_table[_at >> 7] = &DISPLAY_::read_console_ram;
	}
	for(_at = 0xd000; _at < 0xd380; _at += 0x80) {
		read_cpu_func_table[_at >> 7] = &DISPLAY_::read_work_ram;
		read_dma_func_table[_at >> 7] = &DISPLAY_::read_work_ram;
	}
	for(_at = 0xd380; _at < 0xd400; _at += 0x80) {
		read_cpu_func_table[_at >> 7] = &DISPLAY_::read_shared_ram;
		read_dma_func_table[_at >> 7] = &DISPLAY_::read_shared_ram;
	}
#if defined(_FM77AV_VARIANTS)
	for(_at = 0xd400; _at < 0xd500; _at += 0x80) {
		read_cpu_func_table[_at >> 7] = &DISPLAY_::read_mmio;
		read_dma_func_table[_at >> 7] = &DISPLAY_::read_mmio;
	}
	for(_at = 0xd500; _at < 0xd800; _at += 0x80) {
		read_cpu_func_table[_at >> 7] = &DISPLAY_::read_hidden_ram;
		read_dma_func_table[_at >> 7] = &DISPLAY_::read_hidden_ram;
	}
#else
	...
	for(_at = 0xd800; _at < 0xe000; _at += 0x80) {
		read_cpu_func_table[_at >> 7] = &DISPLAY_::read_cgrom;
		read_dma_func_table[_at >> 7] = &DISPLAY_::read_cgrom;
	}
	for(_at = 0xe000; _at < 0x10000; _at += 0x80) {
		read_cpu_func_table[_at >> 7] = &DISPLAY_::read_subsys_monitor;
		read_dma_func_table[_at >> 7] = &DISPLAY_::read_subsys_monitor;
	}
}

uint32_t DISPLAY_::read_console_ram(uint32_t addr)
{
...
uint32_t DISPLAY_::read_work_ram(uint32_t addr)
{
	addr = addr & 0x3ff;
...
uint32_t DISPLAY_::read_shared_ram(uint32_t addr)
{
	addr = addr - 0xd380;
...
#if defined(_FM77AV_VARIANTS)
uint32_t DISPLAY_::read_hidden_ram(uint32_t addr)
{
	if(addr >= 0xd500) {
...
uint32_t DISPLAY_::read_cgrom(uint32_t addr)
{
#if defined(_FM77AV_VARIANTS)
...
uint32_t DISPLAY_::read_subsys_monitor(uint32_t addr)
{
#if defined(_FM77AV40) || defined(_FM77AV40SX) || defined(_FM77AV40EX)
	if(monitor_ram) {
...
uint32_t DISPLAY_::read_dma_data8(uint32_t addr)
{
	uint32_t raddr = (addr & 0xffff) >> 7;
...
uint32_t DISPLAY_::read_data8(uint32_t addr)
{
	uint32_t raddr = addr;
	uint32_t offset;
	if(addr < 0x10000) {
...
void DISPLAY_::write_mmio(uint32_t addr, uint8_t data)
{
	uint8_t rval = 0;
...
void DISPLAY_::init_write_table(void)
{
	uint32_t _at;
	for(_at = 0 ; _at < 0xc000; _at += 0x80) {
		write_cpu_func_table[_at >> 7] = &DISPLAY_::write_cpu_vram_data8;
		write_dma_func_table[_at >> 7] = &DISPLAY_::write_dma_vram_data8;
	}
	for(_at = 0xc000; _at < 0xd000; _at += 0x80) {
		write_cpu_func_table[_at >> 7] = &DISPLAY_::write_console_ram;
		write_dma_func_table[_at >> 7] = &DISPLAY_::write_console_ram;
	}
	for(_at = 0xd000; _at < 0xd380; _at += 0x80) {
		write_cpu_func_table[_at >> 7] = &DISPLAY_::write_work_ram;
		write_dma_func_table[_at >> 7] = &DISPLAY_::write_work_ram;
	}
	for(_at = 0xd380; _at < 0xd400; _at += 0x80) {
		write_cpu_func_table[_at >> 7] = &DISPLAY_::write_shared_ram;
		write_dma_func_table[_at >> 7] = &DISPLAY_::write_shared_ram;
	}
#if defined(_FM77AV_VARIANTS)
	for(_at = 0xd400; _at < 0xd500; _at += 0x80) {
		write_cpu_func_table[_at >> 7] = &DISPLAY_::write_mmio;
		write_dma_func_table[_at >> 7] = &DISPLAY_::write_mmio;
	}
	for(_at = 0xd500; _at < 0xd800; _at += 0x80) {
		write_cpu_func_table[_at >> 7] = &DISPLAY_::write_hidden_ram;
		write_dma_func_table[_at >> 7] = &DISPLAY_::write_hidden_ram;
	}
#else
	for(_at = 0xd400; _at < 0xd800; _at += 0x80) {
		write_cpu_func_table[_at >> 7] = &DISPLAY_::write_mmio;
...
#if defined(_FM77AV40) || defined(_FM77AV40SX) || defined(_FM77AV40EX)
	for(_at = 0xd800; _at < 0xe000; _at += 0x80) {
		write_cpu_func_table[_at >> 7] = &DISPLAY_::write_subsys_cgram;
		write_dma_func_table[_at >> 7] = &DISPLAY_::write_subsys_cgram;
	}
	for(_at = 0xe000; _at < 0x10000; _at += 0x80) {
		write_cpu_func_table[_at >> 7] = &DISPLAY_::write_subsys_ram;
		write_dma_func_table[_at >> 7] = &DISPLAY_::write_subsys_ram;
	}
#else
	for(_at = 0xd800; _at < 0x10000; _at += 0x80) {
		write_cpu_func_table[_at >> 7] = &DISPLAY_::write_dummy;
		write_dma_func_table[_at >> 7] = &DISPLAY_::write_dummy;
	}
#endif
}

void DISPLAY_::write_console_ram(uint32_t addr, uint8_t data)
{
	uint32_t raddr = addr & 0xfff;
#if defined(_FM77AV40) || defined(_FM77AV40EX) || defined(_FM77AV40SX)
	if(monitor_ram) {
...
void DISPLAY_::write_work_ram(uint32_t addr, uint8_t data)
{
	uint32_t raddr = addr & 0xfff;
	work_ram[raddr] = data;
	return;
...
void DISPLAY_::write_shared_ram(uint32_t addr, uint8_t data)
{
...
#if defined(_FM77AV40) || defined(_FM77AV40SX) || defined(_FM77AV40EX)
void DISPLAY_::write_subsys_cgram(uint32_t addr, uint8_t data)
{
...
void DISPLAY_::write_subsys_ram(uint32_t addr, uint8_t data)
{
	if(ram_protect) return;
	if(!monitor_ram) return;
...
#if defined(_FM77AV_VARIANTS)
void DISPLAY_::write_hidden_ram(uint32_t addr, uint8_t data)
{
...
void DISPLAY_::write_cpu_vram_data8(uint32_t addr, uint8_t data)
{
...
void DISPLAY_::write_dma_vram_data8(uint32_t addr, uint8_t data)
{
	uint32_t color = (addr & 0xc000) >> 14;
#if defined(_FM77AV40) || defined(_FM77AV40EX) || defined(_FM77AV40SX)
	if(display_mode == DISPLAY_MODE_8_400L) {
...
void DISPLAY_::write_dummy(uint32_t addr, uint8_t data)
{
}

void DISPLAY_::write_data8(uint32_t addr, uint32_t data)
{
	uint32_t offset;
	uint32_t raddr;
...
uint32_t DISPLAY_::read_bios(const _TCHAR *name, uint8_t *ptr, uint32_t size)
{
	FILEIO fio;
	uint32_t blocks;
	const _TCHAR *s;
...
void DISPLAY_::initialize()
{
	...
	screen_update_flag = true;
	memset(gvram, 0x00, __FM7_GVRAM_PAG_SIZE);
	vram_wrote_shadow = false;
	memset(gvram_shadow, 0x00, __FM7_GVRAM_PAG_SIZE);
	for(i = 0; i < 411 * 5; i++) vram_wrote_table[i] = false;
	for(i = 0; i < 411; i++) vram_draw_table[i] = false;
	force_update = false;

	memset(console_ram, 0x00, 0x1000);
	memset(work_ram, 0x00, 0x380);
	memset(shared_ram, 0x00, 0x80);
	memset(subsys_c, 0xff, 0x2800);
	need_transfer_line = true;
	frame_skip_count_draw = 3;
	frame_skip_count_transfer = 3;
...
void DISPLAY_::release()
{
}

#define STATE_VERSION 12
bool DISPLAY_::decl_state(FILEIO *state_fio, bool loading)
{
	...
	}
	{
		...
		state_fio->StateArray(console_ram, 0x1000, 1);
		state_fio->StateArray(work_ram, 0x380, 1);
		state_fio->StateArray(shared_ram, 0x80, 1);
		state_fio->StateArray(subsys_c, 0x2800, 1);
		state_fio->StateArray(gvram, __FM7_GVRAM_PAG_SIZE, 1);
		state_fio->StateArray(gvram_shadow, __FM7_GVRAM_PAG_SIZE, 1);
...
void DISPLAY_::save_state(FILEIO *state_fio)
{
	decl_state(state_fio, false);
}

bool DISPLAY_::load_state(FILEIO *state_fio)
{
