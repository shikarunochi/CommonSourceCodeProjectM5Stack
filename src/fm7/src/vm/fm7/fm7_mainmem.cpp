...
bool FM7_MAINMEM::decl_state(FILEIO *state_fio, bool loading)
{
	...
	state_fio->StateArray(fm7_mainmem_omote, 0x8000, 1);
	state_fio->StateArray(fm7_mainmem_ura, 0x7c00, 1);
	state_fio->StateArray(fm7_mainmem_basicrom, 0x7c00, 1);
	state_fio->StateArray(fm7_mainmem_bioswork, 0x80, 1);
